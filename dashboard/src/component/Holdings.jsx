...
function Holdings() {
    ...
    async function getArr(userId){
        if(userId){
            let getResponse=await axios.get(`http://localhost:3000/holdings/${userId}`,{withCredentials:true});
    ...
    async function deleteHoldings(data){
        let deleteResponse=await axios.put("http://localhost:3000/holdings",data,{withCredentials:true});
        console.log(deleteResponse.data);
    }
